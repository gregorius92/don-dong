        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-xs text-slate-500 font-medium mt-0.5">
                    Lengkapi informasi varian rasa, harga display, dan unggah foto kemasan
                </p>
            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea name="description"
                                              ...
                                              class="w-full rounded-xl bg-white text-slate-900 placeholder-slate-400 font-medium text-sm border-slate-300 shadow-xs focus:border-emerald-600 focus:ring-emerald-600 leading-relaxed">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description_en"
                                              ...
                                              class="w-full rounded-xl bg-white text-slate-900 placeholder-slate-400 font-medium text-sm border-slate-300 shadow-xs focus:border-emerald-600 focus:ring-emerald-600 leading-relaxed">{{ old('description_en') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="ingredients"
                                              ...
                                              class="w-full rounded-xl bg-white text-slate-900 placeholder-slate-400 font-medium text-sm border-slate-300 shadow-xs focus:border-emerald-600 focus:ring-emerald-600 leading-relaxed">{{ old('ingredients') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full h-56 rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 flex items-center justify-center overflow-hidden relative shadow-inner p-3">
                                ...
                                <template x-if="!imagePreviewUrl">
                                    <div class="text-center text-slate-400 p-4">
                                        ...
                                        <div class="text-[11px] text-slate-400 mt-0.5">Pilih file di bawah untuk melihat hasil</div>
                                    </div>
                                </template>
                            </div>
